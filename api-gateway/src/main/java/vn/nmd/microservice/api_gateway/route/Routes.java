...
public class Routes {
	...
	public RouterFunction<ServerResponse> productServiceRoute(){
		...
		// Every request url that match '/api/product' will be forwarded to productServiceUrl
		// Note: You can use another function that RequestPredicates support to match your request with the destination.
